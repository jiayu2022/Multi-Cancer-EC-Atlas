...
setwd("/home/zhangjiayu/project/EC/rawdata/2021PNASrcc")
...
scRNA <- CreateSeuratObject(counts = count2, project = "2021_PNAS_RCC", meta.data = meta,
...
saveRDS(scRNA, file = "/home/zhangjiayu/project/EC/input/2021pnasgc1.rds")
