...
setwd("/home/zhangjiayu/project/EC/rawdata/2020CRlc")
...
scRNA = readRDS(file = "input/scRNAsampleid.rds")
...
saveRDS(count2, file = "input/count2s.rds")

meta = scRNA@meta.data

saveRDS(meta, file = "input/meta.rds")

rm(list=ls())

count2 = readRDS(file = "input/count2s.rds")
...
meta = readRDS(file = "input/meta.rds")

scRNA <- CreateSeuratObject(counts = count3, project = "2020_CR_LC", meta.data = meta,
...
ggsave("QC/vlnplot_before_qc.pdf", plot = violin, width = 18, height = 5)
...
saveRDS(scRNA, file = "/home/zhangjiayu/project/EC/input/2020crlc1.rds")
