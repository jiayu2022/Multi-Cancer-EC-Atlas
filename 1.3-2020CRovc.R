...
setwd("/home/zhangjiayu/project/EC/rawdata/2020CRovc")
...
scRNA <- CreateSeuratObject(counts = count2, project = "2020_CR_OVC", meta.data = meta,
...
saveRDS(scRNA, file = "/home/zhangjiayu/project/EC/input/2020crovc1.rds")
