...
setwd("/home/zhangjiayu/project/EC/rawdata/2020CRcrc")
...
scRNA <- CreateSeuratObject(counts = count2, project = "2020_CR_CRC", meta.data = meta,
...
saveRDS(scRNA, file = "/home/zhangjiayu/project/EC/input/2020crcrc1.rds")
